...
BEGIN {
  $Test::Apocalypse::MinimumVersion::VERSION = '1.000';
}
BEGIN {
...
=head1 VERSION
  ...
  This document describes v1.000 of Test::Apocalypse::MinimumVersion - released March 04, 2011 as part of Test-Apocalypse.
